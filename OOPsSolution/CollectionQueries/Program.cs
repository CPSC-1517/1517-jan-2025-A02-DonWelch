...
//one such method is .Find(predicate) (single record); .FindAll(predicate) (list of records)
...
//In Linq .FindAll can be replaced with .Where (returning a collection of records)
//        .Find can be replace by adding a method to .Where() called .FirstOrDefault()
//.Where will return by default a collection of all instances matching the condition
//the default for Linq  collections is IEnumerable or IQueryable
